...
A lightweight productivity + mindfulness experiment exploring how to stream a live HTML canvas into
...
The idea is to draw a live animation (timer/avatar UI) on a <canvas>, capture it as a MediaStream,
feed it into a <video>, then open PiP from that video.
...
Then open:
   ...
   http://localhost:8000/browswerPIP.html
